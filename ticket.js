...
const generateButton = document.getElementById('generateButton'); // Reference to the "Generate Ticket" button
...
function generateTicket() {
    ...
    // Disable the "Generate Ticket" button
    generateButton.disabled = true;
    generateButton.textContent = "Ticket Generated"; // Optionally change the button text
}
